...
<head>
	...
	<link rel="stylesheet" href="/wp-content/themes/wp-bootstrap-4/informatics.css">
	<script src="https://cdn.jsdelivr.net/npm/vue"></script>
	<script src="/wp-content/themes/wp-bootstrap-4/assets/js/informatics.js"></script>
		...
		<div class="container-fluid" style="background-color: #e5e5e5; color:#c2c2c2;">
			<div class="row">
                <div class="col-md-6 d-flex align-items-center justify-content-center justify-content-md-start">
                    ...
                    <a class="btn btn-link p-1 m-1"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-link p-1 m-1"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-link p-1 m-1"><i class="fab fa-youtube"></i></a>
                </div>
                <div class="col-md-6 text-md-right text-center">
                    <p class="p-1 m-1">
                        <i class="oi oi-envelope-closed"></i> info.marketing@inforamtics.com.ph
                    </p>
                </div>
            </div>
		</div>
